...
<?php query_posts( /* $slideshowArgs */ 'cat='.$category.'&posts_per_page=$n_slices' ); if( have_posts() ) : while( have_posts() ) : the_post(); ?>
	...
	<li>
		<figure>
			...
			<figcaption data-position="bottom left, 33%">
				<?php the_content(); ?>
			</figcaption>
		</figure>
	</li>
