...
<?php else : ?>
			...
			<div id="post-0" class="post no-results not-found">
				...
				<div class="entry-content">
					<p><?php _e( 'Well this is embarrassing. Looks like I couldn\'t find what you were looking for. Maybe try some different words to search on.', 'sandbox' ) ?></p>
				</div>
				<form id="searchform-no-results" class="blog-search" method="get" action="<?php bloginfo('home') ?>">
					<div>
						...
						<input class="button" type="submit" value="<?php _e( 'Find This Instead', 'sandbox' ) ?>" />
					</div>
				</form>
			</div><!-- .post -->
