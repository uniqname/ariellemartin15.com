...
// =============================== Bueno Search widget ======================================
function bueno_search_widget() {
	get_search_form();
}
wp_register_sidebar_widget( 'bueno-search', __( 'Bueno Search', 'woothemes' ), 'bueno_search_widget' );

// =============================== Bueno Featured widget ======================================
...
class Bueno_featured extends WP_Widget {
   ...
   function widget($args, $instance) {
	...
	remove_action( 'init', 'post_flair_init', 999 );
	remove_filter( 'the_content', 'post_flair_hooks', 100 );
	remove_filter( 'the_content', 'polldaddy_show_rating', 5 );
	remove_filter( 'the_excerpt', 'polldaddy_show_rating_excerpt_for_real' );
     ...
     <h3><?php echo $title; ?></h3>
        <ul>
			...
			<li <?php if ( '' != get_the_post_thumbnail() ): ?>class="has-thumbnail"<?php endif; ?>>
