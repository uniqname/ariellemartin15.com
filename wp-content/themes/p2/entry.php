		...
		<span class="meta">
			...
			<span class="actions">
				<?php if ( ! is_singular() ) : ?>
					...
					<a href="<?php the_permalink(); ?>" class="thepermalink" title="<?php _e( 'Permalink', 'p2' ); ?>"><?php _e( 'Permalink', 'p2' ); ?></a>
				<?php endif;
				...
				if ( current_user_can( 'edit_post', get_the_ID() ) ) : ?> | <a href="<?php echo ( get_edit_post_link( get_the_ID() ) ); ?>" class="edit-post-link" rel="<?php the_ID(); ?>" title="<?php _e( 'Edit', 'p2' ); ?>"><?php _e( 'Edit', 'p2' ); ?></a>
				<?php endif; ?>
