...
?>
	...
	<?php /* Display only titles and date for sidebar search results */ if (get_option('redo_livesearchposition') == 0 and is_search()) { ?>
		<p class="entry-title"><span class="published_tiny"><?php echo get_the_time('d/m','redo_domain'); ?></span><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permanent link to %s', 'redo_domain' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></p>
	<?php } else { ?>
