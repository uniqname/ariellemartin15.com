	...
	<div id="middlecolumn">
		<div id="primary"  class="primaryPage">
				...
				<div id="<?php echo $prefix; ?>primarycontent" class="hfeed">
					...
					<div class="page-head">
						<h2><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permanent link to %s', 'redo_domain' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h2>
					</div>
