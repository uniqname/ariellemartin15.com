...
<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="post-content">
		...
		<?php endif; ?>
		<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'manifest' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><img class="entry-image" src="<?php echo $first_attachment->guid; ?>?w=500" alt="<?php echo esc_attr( $first_attachment->post_title ); ?>" /></a>
