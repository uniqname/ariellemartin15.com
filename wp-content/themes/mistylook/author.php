...
?>
<h2><?php _e('About:','mistylook'); ?> <?php echo $curauth->first_name . ' ' . $curauth->last_name; ?></h2>
<dl>
...
<dd><?php echo $curauth->description; ?></dd>
			...
			<h2><?php printf(__('Posts by %s:','mistylook'), $curauth->first_name . ' ' . $curauth->last_name ); ?></h2>
