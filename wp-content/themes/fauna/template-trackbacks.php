...
<?php } ?>
	...
	<li><a name="comment-<?php comment_ID() ?>" href="<?php echo($comment->comment_author_url); ?>" title="Visit <?php echo($comment->comment_author); ?>">
		<?php if (function_exists('comment_favicon')) { comment_favicon($before='<img src="', $after='" alt="" class="trackback-avatar" />'); }; ?>
		<strong><u><?php echo($comment->comment_author); ?></u></strong>
		<small>
