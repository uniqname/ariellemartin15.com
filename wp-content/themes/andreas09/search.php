...
<?php include (TEMPLATEPATH . '/right-sidebar.php'); ?>
	...
	<?php if (have_posts()) : ?>
		...
		<?php the_excerpt(''); ?>
		<p><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permanent link to %s' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php _e('Read the rest of this post...','andreas09'); ?></a></p>
