						...
						<?php
							...
							foreach ( piano_black_search() as $option ) {
								...
								<label class="description">
									<input type="radio" name="piano_black_theme_options[theme_search]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php echo $checked; ?> />
									<span>
					...
					<td>
						...
						<?php
							...
							foreach ( piano_black_rss() as $option ) {
								...
								<div class="layout">
								<label class="description">
									<input type="radio" name="piano_black_theme_options[theme_rss]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php echo $checked; ?> />
									<span>
										<?php echo $option['label']; ?>
									</span>
								</label>
