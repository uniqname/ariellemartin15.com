...
function hemingway_add_theme_options_page() {
	$page = add_theme_page( __( 'Theme Options', 'hemingway' ), __( 'Theme Options', 'hemingway' ), 'edit_theme_options', 'theme_options', 'hemingway_theme_options' );
...
function hemingway_theme_options() {
	...
	<div class="wrap" style="position:relative;">
		...
		<ul id="addables">
			...
			<li id="<?php echo esc_attr( $ref ); ?>" class="blocks"><?php echo $name; ?></li>
