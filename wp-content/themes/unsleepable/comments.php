...
<div class="comments" id="comments">
	...
	<div class="metalinks">
		...
		<?php if (pings_open()) { ?><span class="trackbacklink"><a href="<?php trackback_url() ?>" title="<?php esc_attr_e( 'Copy this URI to trackback this entry.', 'unsleepable' ); ?>">Trackback Address</a></span><?php } ?>
	</div>
