			...
			<table class="form-table">
						...
						<?php
							...
							foreach ( mystique_layouts() as $option ) {
								...
								<label class="description">
									<input type="radio" name="mystique_theme_options[theme_layout]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php echo $checked; ?> />
									<span>
				...
				<tr valign="top" id="mystique-social-icons"><th scope="row"><?php _e( 'Social Icons', 'mystique' ); ?></th>
					<td>
						...
						<div>
							<input id="mystique_theme_options[facebook_link]" class="regular-text" type="text" name="mystique_theme_options[facebook_link]" value="<?php echo esc_attr( $options['facebook_link'] ); ?>" />
							<label class="description" for="mystique_theme_options[facebook_link]"><?php _e( 'Enter your Facebook URL.', 'mystique' ); ?></label>
						</div>

						<div>
							<input id="mystique_theme_options[twitter_link]" class="regular-text" type="text" name="mystique_theme_options[twitter_link]" value="<?php echo esc_attr( $options['twitter_link'] ); ?>" />
							<label class="description" for="mystique_theme_options[twitter_link]"><?php _e( 'Enter your Twitter URL.', 'mystique' ); ?></label>
						</div>

						<div>
							<input id="mystique_theme_options[flickr_link]" class="regular-text" type="text" name="mystique_theme_options[flickr_link]" value="<?php echo esc_attr( $options['flickr_link'] ); ?>" />
							<label class="description" for="mystique_theme_options[flickr_link]"><?php _e( 'Enter your Flickr URL.', 'mystique' ); ?></label>
						</div>

						<div>
							<input id="mystique_theme_options[youtube_link]" class="regular-text" type="text" name="mystique_theme_options[youtube_link]" value="<?php echo esc_attr( $options['youtube_link'] ); ?>" />
				...
				<tr valign="top" id="mystique-featured-post-label"><th scope="row"><?php _e( 'Featured Post Label', 'mystique' ); ?></th>
					<td>
						...
						<div>
							<input id="mystique_theme_options[featured_post_label]" class="regular-text" type="text" name="mystique_theme_options[featured_post_label]" value="<?php echo esc_attr( $options['featured_post_label'] ); ?>" />
