		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Facebook URL', 'liquorice' ); ?></th>
					<td>
						<input id="liquorice_theme_options[facebookurl]" class="regular-text" type="text" name="liquorice_theme_options[facebookurl]" value="<?php echo esc_attr( $options['facebookurl'] ); ?>" />
				...
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Twitter URL', 'liquorice' ); ?></th>
					<td>
						<input id="liquorice_theme_options[twitterurl]" class="regular-text" type="text" name="liquorice_theme_options[twitterurl]" value="<?php echo esc_attr( $options['twitterurl'] ); ?>" />
