		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Random Photos Gallery header:', 'matala' ); ?></th>
					<td>
						<input id="matala_theme_options[random_photos_header]" class="regular-text" type="text" name="matala_theme_options[random_photos_header]" value="<?php echo esc_attr( $options['random_photos_header'] ); ?>" />
