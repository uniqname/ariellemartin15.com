	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
					...
					<td>
						...
						<?php
							...
							foreach ( selecta_featured_slider() as $option ) {
								...
								<div class="layout">
								<label class="description">
									<input type="radio" name="selecta_theme_options[theme_slider]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php echo $checked; ?> />
									<span>
										<?php echo $option['label']; ?>
									</span>
								</label>
				...
				<tr valign="top" id="selecta-latest-posts"><th scope="row"><?php _e( 'Show Latest Posts row on the front page', 'selecta' ); ?></th>
					<td>
						<fieldset><legend class="screen-reader-text"><span><?php _e( 'Show Latest Posts row on the front page', 'selecta' ); ?></span></legend>
						<?php
							if ( ! isset( $checked ) )
								$checked = '';
							foreach ( selecta_latest_posts() as $option ) {
								...
								<div class="layout">
								<label class="description">
									<input type="radio" name="selecta_theme_options[theme_latest_posts]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php echo $checked; ?> />
									<span>
										<?php echo $option['label']; ?>
									</span>
								</label>
