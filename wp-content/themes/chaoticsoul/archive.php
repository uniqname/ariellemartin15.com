...
<?php /* If this is a category archive */ if (is_category()) { ?>
	 ...
	 <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
	  ...
	  <?php /* If this is an author archive */ } elseif (is_author()) { ?>
		...
		<div <?php post_class(); ?>>
			<h2 id="post-<?php the_ID(); ?>"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permanent Link to %s', 'chaoticsoul'  ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h2>
