jQuery(function(){
  ...
  jQuery("#menu > li:first-child.current_page_item, #menu > li:first-child.current-cat").addClass("first_menu_active");
  jQuery("#menu > li:last-child").addClass("last_menu");
  jQuery("#menu > li:last-child.current_page_item, #menu > li:last-child.current-cat").addClass("last_menu_active");
  ...
  jQuery(".search_tag").toggle(function(){
    jQuery(".search_tag").addClass("active_search_tag");
    jQuery("#tag_list ul").animate({ opacity: 'show', height:"show" }, {duration:1000 ,easing:"easeOutBack"});
    return false;
  },function(){
    jQuery("#tag_list ul").fadeTo("slow", 0).slideUp("slow").fadeTo("fast", 1);
    jQuery(".search_tag").removeClass("active_search_tag")
    return false;
  });
