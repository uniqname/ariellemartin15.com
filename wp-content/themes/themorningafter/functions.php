...
function morning_after_post_meta() {
	printf( __( '<span class="byline">Posted by <a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></span> <span class="entry-date"><span class="dot">&sdot;</span> <time class="entry-date" datetime="%4$s" pubdate>%5$s</time></span>', 'woothemes'),
		esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
		esc_attr( sprintf( __( 'View all posts by %s', 'woothemes' ), get_the_author_meta( 'display_name' ) ) ),
