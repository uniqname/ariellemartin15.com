<?php get_header(); ?>
	...
	<div id="content">
		...
		<li>You could visit <a href="<?php echo home_url( '/' ); ?>">the homepage</a></li>
		...
		if (have_posts()) : while (have_posts()) : the_post(); ?>
			<li><a href="<?php the_permalink() ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink for : %s' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a>
		<?php endwhile; endif; ?>
		</ul>
