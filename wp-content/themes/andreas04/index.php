        ...
        <?php if (have_posts()) : ?>
          ...
          <?php while (have_posts()) : the_post(); ?>
              ...
              <div id="post-<?php the_ID(); ?>" <?php post_class( 'entry' ); ?>>
                ...
                <h2><a href="<?php the_permalink() ?>" title="<?php printf( esc_attr__('Permalink to %s', 'andreas04'), the_title_attribute('echo=0') ); ?>"><?php the_title(); ?></a></h2>
                ...
                <span class="date"><?php $arc_year = get_the_time('Y'); $arc_month = get_the_time('m'); $arc_day = get_the_time('d'); ?><a href="<?php echo get_day_link("$arc_year", "$arc_month", "$arc_day"); ?>"><?php the_time(get_option("date_format")); ?></a> <!-- at <?php the_time()  ?> --></span>
                  ...
                  <?php the_category(', '); ?>
				  <?php the_tags( ' | ', ', ', ''); ?> |
                  <?php comments_popup_link( __( 'Leave a Comment', 'andreas04' ), __( '1 Comment', 'andreas04' ), __( '% Comments', 'andreas04' ) ); ?>
