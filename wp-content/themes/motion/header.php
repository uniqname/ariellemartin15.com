...
<div id="top">
	...
	<div id="search">
		<form method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
			<p>
				<input type="text" value="<?php esc_attr_e ( 'Search this site...' ); ?>" onfocus="if (this.value == '<?php esc_attr_e( 'Search this site...' ); ?>' ) { this.value = ''; }" onblur="if (this.value == '' ) { this.value = '<?php esc_attr_e( 'Search this site...' ); ?>'; }" name="s" id="searchbox" />
				<input type="submit" class="submitbutton" value="<?php esc_attr_e( 'GO' ); ?>" />
			</p>
		</form>
	</div>
</div><!-- /top -->
