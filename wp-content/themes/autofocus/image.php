		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div id="entry-meta">
				...
				<span class="bookmark-permalink">
					<?php printf( __( 'Bookmark the <a href="%1$s" title="Permalink to %2$s" rel="bookmark">permalink</a>.', 'autofocus' ), esc_url( get_permalink() ), the_title_attribute( 'echo=0' ) ); ?>
				</span>
				<span class="comments-rss-link">
					<?php printf( __( 'Follow any comments here with the <a href="%1$s" title="RSS feed for %2$s">RSS feed for this post</a>.', 'autofocus' ), get_post_comments_feed_link(), the_title_attribute( 'echo=0' ) ); ?>
