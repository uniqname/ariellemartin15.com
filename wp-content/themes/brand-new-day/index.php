	...
	<?php if ( have_posts() ) : ?>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			<div class="post-sidebar<?php if ( is_sticky() ) echo ' sticky'; ?>">
				<div class="post-date">
					<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php esc_attr_e( 'Permanent Link to' , 'brand-new-day' ); ?> <?php the_title_attribute(); ?>">
			...
			<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				<h2 class="page_title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php esc_attr_e( 'Permanent Link to' , 'brand-new-day' ); ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
