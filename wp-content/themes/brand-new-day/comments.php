...
<?php if ( have_comments() ) : ?>
	<h3 id="comments" class="page_title">
		<?php comments_number( __( 'No Responses' , 'brand-new-day' ) , __( 'One Response' , 'brand-new-day' ) , '% ' . __( 'Responses' , 'brand-new-day' ) );?> <?php _e( 'to' , 'brand-new-day' ); ?> <?php _e( '&#8220;', 'brand-new-day' ) ?><?php the_title(); ?><?php _e( '&#8221', 'brand-new-day' ); ?>
	</h3>
