...
<?php get_header(); ?>
		...
		<h1 class="pagetitle"><?php _e('Archive for', 'vigilance'); ?> <?php the_time(get_option('date_format')); ?></h1>
		...
		<h1 class="pagetitle"><?php printf( __( 'Posts by %s', 'vigilance' ), esc_html( get_the_author_meta( 'display_name', get_queried_object_id() ) ) ); ?></h1>
