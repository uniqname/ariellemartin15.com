...
<?php wp_list_bookmarks('title_before=<h3>&title_after=</h3>&show_images=1') ?>
			...
			<li id="rss-links">
				...
				<ul>
					<li><a href="<?php bloginfo('rss2_url') ?>" title="<?php echo esc_attr( sprintf( __( '%s latest posts', 'sandbox' ), get_bloginfo( 'name', 'display' ) ) ); ?>" rel="alternate" type="application/rss+xml"><?php _e( 'All posts', 'sandbox' ) ?></a></li>
					<li><a href="<?php bloginfo('comments_rss2_url') ?>" title="<?php echo esc_attr( sprintf( __( '%s latest comments', 'sandbox' ), get_bloginfo( 'name', 'display' ) ) ); ?>" rel="alternate" type="application/rss+xml"><?php _e( 'All comments', 'sandbox' ) ?></a></li>
				</ul>
			</li>
