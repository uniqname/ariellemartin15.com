...
function imbalance2_setup() {
	...
	// Add a filter to imbalance2_header_image_width and imbalance2_header_image_height to change these values.
	...
	// custom headers. See imbalance2_admin_header_style(), below.
			...
			<div class="comment-meta commentmetadata">
				<?php
					printf( '<a href="%1$s"><time pubdate datetime="%2$s">%3$s</time></a>',
						...
						get_comment_time( 'c' ),
						sprintf( __( '%1$s at %2$s', 'imbalance2' ), get_comment_date(), get_comment_time() )
					);
				?>
				<?php edit_comment_link( __( '(Edit)', 'imbalance2' ), ' ' ); ?>
